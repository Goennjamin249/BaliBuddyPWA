...
const BALI_POIS: POI[] = [
  ...
  {
    id: "2",
    name: "Aqua Refill Seminyak",
    type: "water",
    latitude: -8.6913,
    longitude: 115.1683,
    description: "Mineralwasser, 6.000 IDR/Liter",
    details: { price: 6000, hours: "07:00-22:00" },
    rating: 4.2,
  ...
  {
    id: "3",
    name: "Bali Water Refill Kuta",
    type: "water",
    latitude: -8.7183,
    longitude: 115.1687,
    description: "Gefiltertes Wasser, 4.000 IDR/Liter",
    details: { price: 4000, hours: "09:00-21:00" },
    rating: 4.0,
    address: "Kuta, Bali",
    category: "water",
    source: "osm",
  ...
  // Laundries - 2026 Prices
  {
    ...
    latitude: -8.6477,
    longitude: 115.1378,
    description: "35.000 IDR/kg, Express +15.000",
    details: { pricePerKg: 35000, express: 15000 },
    rating: 4.7,
    address: "Canggu, Bali",
    category: "laundry",
    source: "osm",
  },
  {
    ...
    latitude: -8.7183,
    longitude: 115.1687,
    description: "40.000 IDR/kg, 24h Service",
    details: { pricePerKg: 40000, hours: "24h" },
    rating: 4.3,
    address: "Kuta, Bali",
    category: "laundry",
    source: "osm",
  ...
  // Safe ATMs
  {
    ...
    latitude: -8.7183,
    longitude: 115.1687,
    description: "Innerhalb der Bank, sicher",
    details: { bank: "BCA", safe: true, fee: 0 },
    rating: 4.8,
    address: "Kuta, Bali",
    category: "atm",
    source: "osm",
  ...
  {
    id: "7",
    name: "Mandiri ATM Seminyak",
    type: "atm",
    latitude: -8.6913,
    longitude: 115.1683,
    description: "Sicherer Standort",
    details: { bank: "Mandiri", safe: true, fee: 0 },
    rating: 4.5,
    address: "Seminyak, Bali",
    category: "atm",
    source: "osm",
  ...
  {
    id: "8",
    name: "Bali Express Ferry",
    type: "ferry",
    latitude: -8.7183,
    longitude: 115.1687,
    description: "Nach Gili Trawangan - 450.000 IDR",
    details: { destination: "Gili Trawangan", eta: "45 min", price: 450000 },
    rating: 4.1,
    address: "Kuta, Bali",
  ...
  },
  {
    ...
    latitude: -8.5069,
    longitude: 115.2624,
    description: "Nach Nusa Lembongan - 350.000 IDR",
    details: { destination: "Nusa Lembongan", eta: "30 min", price: 350000 },
    rating: 4.4,
    address: "Ubud, Bali",
    category: "attractions",
    source: "osm",
  ...
  // Clinics
  {
    ...
    latitude: -8.7183,
    longitude: 115.1687,
    description: "24h Notaufnahme, PEP-Impfung",
    details: { emergency24h: true, hasPep: true, consultation: 500000 },
    rating: 4.9,
    address: "Kuta, Bali",
    category: "clinic",
    source: "osm",
  },
  {
    ...
    latitude: -8.6477,
    longitude: 115.1378,
    description: "Gute Notfallversorgung",
    details: { emergency24h: true, consultation: 400000 },
    rating: 4.6,
    address: "Canggu, Bali",
    category: "clinic",
    source: "osm",
...
export default function MapScreen() {
  ...
  useEffect(() => {
    // Inject minimal external-like CSS for web map container (avoid inline JSX styles)
    if (Platform.OS === "web") {
      const css = `
        .maplibre-container { width: 100%; height: 100%; }
        .user-marker {
          width: 20px;
          height: 20px;
          border-radius: 50%;
        ...
        .poi-marker--water { background-color: #00B4D8; }
        .poi-marker--laundry { background-color: #90BE6D; }
      ...
      styleTag.setAttribute("data-generated", "maplibre-css");
              ...
              try {
                ...
                mapRef.current.on("load", () => {
                  ...
                  sortedPOIs.forEach((poi) => {
                    ...
                    const typeClass = poi.type || "default";
                    el.className = `poi-marker poi-marker--${typeClass}`;
  ...
  const getPOIIcon = (type: string | undefined) => {
    switch (type) {
      case "water":
        return <Droplets size={20} color="#FFFFFF" />;
      case "laundry":
        return <Shirt size={20} color="#FFFFFF" />;
      case "atm":
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.floatingHeader}>
        ...
        <TouchableOpacity style={styles.refreshButton} onPress={fetchLivePOIs}>
                ...
                <View style={styles.poiInfo}>
                  ...
                  {poi.distance && (
                    <Text style={styles.poiDistance}>
                      {poi.distance.toFixed(1)} km entfernt
                    </Text>
                  )}
                </View>
                {poi.rating && (
              ...
              <View style={styles.bottomSheetTitleContainer}>
                ...
                {selectedPOI.distance && (
                  <Text style={styles.bottomSheetDistance}>
                    {selectedPOI.distance.toFixed(1)} km entfernt
                  </Text>
                )}
              </View>
              <TouchableOpacity
                ...
                <>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>
                      Rp {formatCurrency(selectedPOI.details?.price)}
                      /Liter
                    </Text>
                  </View>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>
                      {String(selectedPOI.details?.hours || "Nicht verfügbar")}
                    </Text>
                  </View>
                </>
              )}
              ...
              {selectedPOI.type === "laundry" && (
                <>
                  <View style={styles.detailRow}>
                    <Text style={styles.detailLabel}>💰 Preis:</Text>
                    <Text style={styles.detailValue}>
                      Rp {formatCurrency(selectedPOI.details?.pricePerKg)}
                      /kg
                    </Text>
                  </View>
                  {selectedPOI.details?.express && (
                    <View style={styles.detailRow}>
                      ...
                      <Text style={styles.detailValue}>
                        +Rp {formatCurrency(selectedPOI.details?.express)}
                      </Text>
                    </View>
                  )}
                </>
              ...
              {selectedPOI.type === "atm" && (
                <>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>
                      {String(selectedPOI.details?.bank || "Nicht verfügbar")}
                    </Text>
                  </View>
                  <View style={styles.detailRow}>
              ...
              {selectedPOI.type === "ferry" && (
                <>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>
                      {String(
                        selectedPOI.details?.destination || "Nicht verfügbar",
                      )}
                    </Text>
                  </View>
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>
                      {String(selectedPOI.details?.eta || "Nicht verfügbar")}
                    </Text>
                  </View>
                  <View style={styles.detailRow}>
                    <Text style={styles.detailLabel}>💰 Preis:</Text>
              ...
              {selectedPOI.type === "clinic" && (
                <>
                  ...
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>
                      Rp {formatCurrency(selectedPOI.details?.consultation)}
                    </Text>
                  </View>
                </>
              )}
              ...
              <View style={styles.bottomSheetActions}>
                {selectedPOI.details?.phone ? (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      handlePhoneCall(String(selectedPOI.details?.phone || ""))
                    }
                  >
