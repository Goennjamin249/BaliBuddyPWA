...
<skill>
<name>rest-api-planning</name>
<description>Analysiert REST-API-Dokumentation und erstellt einen Implementierungsplan. Use when REST-API-Doku, Swagger/OpenAPI oder Endpunktbeschreibungen fuer TypeScript/React ausgewertet werden sollen.</description>
